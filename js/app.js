            ...
            <div class="about-container">
                ...
                <div class="about-content-wrapper">
                    ...
                    <div class="about-text">
                        <p>Greetings! I am a Computer Engineer majoring in Computer Science at Beykoz University, specializing in artificial intelligence (AI) and cybersecurity. I'm looking to participate in practical experiences while helping with real-world projects.</p>
                        <p>I regularly engage in building projects that allow me to test out new programming languages and their frameworks as well as different types of hardware architecture. My principal area of focus is designing scalable microservices and service-oriented architectures (SOA) utilizing cutting-edge message brokers and containerization technologies.</p>
                        <p>As a mobile application developer, I have experience developing mobile applications and leading a team to build many different types of applications such as ExpenseGuard (Enterprise AI Expense Platform), Walletly (Smart Expense Tracker), and GIMBO (Course Helper Application). In addition, I hold certificates from Google and Microsoft in Cybersecurity and Artificial Intelligence Fundamentals.</p>
                        <p>In addition to my studies, I am currently a member of several student clubs including the Computer Engineering Society and the Google Developer Student Clubs (GDSC) at Beykoz University. My goal is to always continue developing my ability to design algorithms and analyze solutions to bridging the gap between academic theory and practical implementation.</p>
                        <p>When I'm not typing away at the keyboard, I try to keep things in balance and maintain a healthy lifestyle. I enjoy staying active through fitness as well as playing football and table tennis. On the creative side, I enjoy playing guitar; in fact, I’m a sucker for building and collecting with Legos! All of these things help recharge my battery and keep my problem-solving skills refreshingly sharp.</p>
                        <p>If you’d like to connect, collaborate or just want to know more about me, don’t hesitate to ask!</p>
                    </div>
                </div>
            </div>
        `,
