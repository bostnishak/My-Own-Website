            ...
            <div class="about-container">
                ...
                <div class="about-content-wrapper">
                    ...
                    <div class="about-text">
                        <p>Hallo! Ich bin Informatikstudent an der Beykoz Universität mit Schwerpunkt auf Künstliche Intelligenz (KI) und Cybersicherheit. Ich strebe danach, praktische Erfahrungen zu sammeln und gleichzeitig an realen Projekten mitzuwirken.</p>
                        <p>Ich beschäftige mich regelmäßig mit der Entwicklung von Projekten, die es mir ermöglichen, neue Programmiersprachen und Frameworks sowie verschiedene Arten von Hardwarearchitekturen zu testen. Mein Hauptaugenmerk liegt auf dem Entwurf skalierbarer Microservices und serviceorientierter Architekturen (SOA) unter Einsatz modernster Message-Broker und Containerisierungstechnologien.</p>
                        <p>Als Entwickler mobiler Anwendungen verfüge ich über Erfahrung in der App-Entwicklung und der Leitung von Teams bei der Erstellung verschiedenster Anwendungen wie ExpenseGuard (Enterprise AI Expense Platform), Walletly (Smart Expense Tracker) und GIMBO (Course Helper Application). Darüber hinaus besitze ich Zertifikate von Google und Microsoft in Cybersicherheit und den Grundlagen der Künstlichen Intelligenz.</p>
                        <p>Zusätzlich zu meinem Studium bin ich derzeit Mitglied in verschiedenen Studentenclubs, darunter die Computer Engineering Society und die Google Developer Student Clubs (GDSC) an der Beykoz Universität. Mein Ziel ist es, meine Fähigkeiten im Entwerfen von Algorithmen und der Lösungsanalyse stetig weiterzuentwickeln, um die Lücke zwischen akademischer Theorie und praktischer Umsetzung zu schließen.</p>
                        <p>Wenn ich nicht gerade an der Tastatur tippe, versuche ich, ein ausgewogenes und gesundes Leben zu führen. Ich halte mich gerne durch Fitness sowie Fußball und Tischtennis aktiv. Auf der kreativen Seite spiele ich gerne Gitarre; außerdem bin ich ein absoluter Fan davon, Lego-Sets zu bauen und zu sammeln! All diese Dinge helfen mir, meine Batterien aufzuladen und meine Problemlösungsfähigkeiten erfrischend scharf zu halten.</p>
                        <p>Wenn Sie sich vernetzen, zusammenarbeiten oder einfach mehr über mich erfahren möchten, zögern Sie nicht, mich zu kontaktieren!</p>
                    </div>
                </div>
            </div>
        `,
